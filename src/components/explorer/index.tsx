                ...
                <>
                  ...
                  >
                    {availableRooms.map((room) => (
                      <RoomCard
                        key={room.id}
                        image={room.fotos?.length > 0 ? { uri: room.fotos[0].url } : require("../../../assets/images/quarto.jpg")}
                        label={room.nome}
                        icon={{
                          lib: "FontAwesome5",
                          name: "bed",
...
const styles = StyleSheet.create({
  ...
  initialTitle: { fontSize: 18, fontWeight: 'bold', color: '#420350ff', marginTop: 15 },
  ...
  emptyTitle: { fontSize: 18, fontWeight: 'bold', color: '#420350ff' },
  emptySubtitle: { textAlign: 'center', color: '#666', marginTop: 5 },
  modalTitle: { fontSize: 24, fontWeight: 'bold', color: '#420350ff', marginBottom: 20 },
